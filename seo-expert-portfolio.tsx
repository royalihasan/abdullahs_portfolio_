  ...
  const education = [
    {
      ...
      year: "2018-2020",
      details: "Specialized in Search Engine Optimization and Content Strategy"
    },
    {
      degree: "Bachelor's in Computer Science",
      school: "Tech University",
      year: "2014-2018",
      details: "Focus on Web Development and Digital Marketing"
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
              ...
              <h2 className="text-xl md:text-2xl mb-6 opacity-90">Senior SEO Expert & Digital Strategist</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-6">
              With over 8 years of experience in SEO and digital marketing, I specialize in creating data-driven strategies 
              that deliver measurable results. My approach combines technical expertise with creative content strategies 
              to help businesses achieve sustainable organic growth.
            </p>
